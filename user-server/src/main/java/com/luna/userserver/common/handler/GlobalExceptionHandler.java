package com.luna.userserver.common.handler;
...
public class GlobalExceptionHandler {
    ...
    public ApiResult<Object> handleResilience4jExceptions(Exception ex) {
        // 处理 Resilience4j 异常
        log.error("处理 Resilience4j 异常");
        return ApiResult.fail(-1, String.format("不支持'%s'请求", ex.getMessage()));
    }
