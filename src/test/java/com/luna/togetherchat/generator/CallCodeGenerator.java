    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.luna.togetherchat.call")
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml,
                                    System.getProperty("user.dir") + "/src/main/resources/mapper/call"));
                })
                .strategyConfig(builder -> {
                    builder.addInclude("call_session", "call_participant", "live_broadcast");
                    ...
                    builder.addTablePrefix("call_", "live_");
                })
